...
export function QuizClient({
  ...
  return (
    <div className="mt-8 animate-fade-in">
      ...
      <div className="rounded-2xl border border-zinc-200/60 bg-white p-6 shadow-sm sm:p-8 dark:border-zinc-700/60 dark:bg-zinc-900 hover-lift">
        <div className="mb-4 flex items-center gap-2">
          <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-indigo-100 text-xs font-bold text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-400">
            {current + 1}
          </span>
          <span className="text-xs font-medium uppercase tracking-wider text-zinc-400">Question</span>
        </div>
